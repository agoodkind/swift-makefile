...
- [Consumer fetch](docs/fetch/overview.md) covers the fetched `.make` package, the `SWIFT_MK_SCRIPT_FILES` manifest, and the completeness invariant that keeps a consumer's `swift-mk` build buildable.
