...
$(if $(filter ok,$(shell mkdir -p .make && if $(call _swift_mk_fetch,osv-scanner.toml,$(SWIFT_MK_OSV_CONFIG)); then printf ok; else printf fail; fi)),,$(error swift-makefile failed to fetch osv-scanner.toml))
